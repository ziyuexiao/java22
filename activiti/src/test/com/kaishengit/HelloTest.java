...
public class HelloTest {
    ...
    public void deployProcess(){
        ...
        .name("Hello")//添加部署的名称,写到表act_re_deployment
        .addClasspathResource("diagrams/Hello.bpmn")//
        .addClasspathResource("diagrams/Hello.png")//一次只能加载一个，部署流程资源文件BPMN/png
        .deploy();//完成部署
    ...
    public void startProcess(){
        ProcessInstance pi = processEngine.getRuntimeService()
                .startProcessInstanceByKey("myProcess");//act_re_procdef中找key值
