...
public class ParallelTest {
    ...
    public void deployProcess(){
        Deployment deployment = processEngine.getRepositoryService()//获取repositoryservice
                ...
                .name("parallel")//添加部署的名称
                .addClasspathResource("diagrams/Parallel.bpmn")//
                .addClasspathResource("diagrams/Parallel.png")//一次只能加载一个，部署流程资源文件BPMN/png
                .deploy();//完成部署
    ...
    public void startProcess(){
        ProcessInstance pi = processEngine.getRuntimeService()
                .startProcessInstanceByKey("parallel");//act_re_procdef中找key值
