...
public class TaskTest {
    ...
    public void deployProcess(){
        Deployment deployment = processEngine.getRepositoryService()//获取repositoryservice
                ...
                .name("Task")//添加部署的名称,写到表act_re_deployment
                .addClasspathResource("diagrams/Task.bpmn")//
                .addClasspathResource("diagrams/Task.png")//一次只能加载一个，部署流程资源文件BPMN/png
                .deploy();//完成部署
    ...
    public void startProcess(){
        ...
        //通过设置申请人获取申请人的部门经理id
        map.put("userId","李四task");
        ProcessInstance pi = processEngine.getRuntimeService()
                .startProcessInstanceByKey("task",map);//act_re_procdef中找key值
